                                            ...
                                            <div class="box p-a-xs">
                                                ...
                                                <div class="p-a-sm">
                                                    <div class="text-ellipsis">
                                                        ...
                                                        <?php endif; ?>
                                                        <a  style="display: block;overflow: hidden;" href="<?php echo e(URL::to('uploads/topics/'.$photo->file)); ?>"
                                                           target="_blank"> <small> <?php echo e(($photo->title !="") ? $photo->title:$photo->file); ?></small></a>
                                                    </div>
                                                </div>
                                            ...
                                            <?php $__currentLoopData = $Topics->attachFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo e(URL::to('uploads/topics/'.$file->file)); ?>" target="_blank">
                                                    ...
                                                    <td class="text-center">
                                                        <a class="btn btn-sm success"
                                                           href="<?php echo e(route("topicsFilesEdit",["webmasterId"=>$WebmasterSection->id,"id"=>$Topics->id,"comment_id"=>$file->id])); ?>">
                                                            <small><i class="material-icons">
                                                                    &#xe3c9;</i> <?php echo e(trans('backLang.edit')); ?></small>
                                                        </a>
                                                        <?php if(@Auth::user()->permissionsGroup->delete_status): ?>
                                                    ...
                                                    <div class="modal-dialog" id="animate">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn dark-white p-x-md"
                                                                        data-dismiss="modal"><?php echo e(trans('backLang.no')); ?></button>
                                                                <a href="<?php echo e(route("topicsFilesDestroy",["webmasterId"=>$WebmasterSection->id,"id"=>$Topics->id,"comment_id"=>$file->id])); ?>"
                                                                   class="btn danger p-x-md"><?php echo e(trans('backLang.yes')); ?></a>
                                                            </div>
                                                        </div><!-- /.modal-content -->
                                                    </div>
