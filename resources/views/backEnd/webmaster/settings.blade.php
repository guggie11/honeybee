            ...
            <div class="form-group">
                ...
                <select name="home_content1_section_id" id="home_content1_section_id" class="form-control c-select">
                    ...
                    @foreach ($GeneralWebmasterSections as $WebmasterSection)
                        <?php
                        ?>
                        <option value="{{ $WebmasterSection->id  }}" {{ ($WebmasterSection->id == $WebmasterSetting->home_content1_section_id) ? "selected='selected'":""  }}>{!! str_replace("backLang.","",trans('backLang.'.$WebmasterSection->name))   !!}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="home_content2_section_id" id="home_content2_section_id" class="form-control c-select">
                    ...
                    @foreach ($GeneralWebmasterSections as $WebmasterSection)
                        <?php
                        ?>
                        <option value="{{ $WebmasterSection->id  }}" {{ ($WebmasterSection->id == $WebmasterSetting->home_content2_section_id) ? "selected='selected'":""  }}>{!! str_replace("backLang.","",trans('backLang.'.$WebmasterSection->name))   !!}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="latest_news_section_id" id="latest_news_section_id" class="form-control c-select">
                    ...
                    @foreach ($GeneralWebmasterSections as $WebmasterSection)
                        <?php
                        ?>
                        <option value="{{ $WebmasterSection->id  }}" {{ ($WebmasterSection->id == $WebmasterSetting->latest_news_section_id) ? "selected='selected'":""  }}>{!! str_replace("backLang.","",trans('backLang.'.$WebmasterSection->name))  !!}</option>
                    @endforeach
                </select>
            </div>
