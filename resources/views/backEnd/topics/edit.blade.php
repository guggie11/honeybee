                ...
                icons: {
                  ...
                  <span class="fa fa-calendar"></span>
                        ...
                        @if($WebmasterSection->type==2)
                            ...
                            <div class="form-group row" id="vimeo_link_div" style="display: {{ ($Topics->video_type ==2) ? "block" : "none" }}">
                                <label for="youtube_link"
                            ...
                            <div class="form-group row" id="embed_link_div" style="display: {{ ($Topics->video_type ==3) ? "block" : "none" }}">
                                            ...
                                            <div class="box p-a-xs">
                                                ...
                                                <div class="p-a-sm">
                                                    <div class="text-ellipsis">
                                                        ...
                                                        @endif
                                                        <a  style="display: block;overflow: hidden;" href="{{ URL::to('uploads/topics/'.$photo->file) }}"
                                                           target="_blank"> <small> {{ ($photo->title !="") ? $photo->title:$photo->file  }}</small></a>
                                                    </div>
                                                </div>
                                            ...
                                            @foreach($Topics->attachFiles as $file)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ URL::to('uploads/topics/'.$file->file) }}" target="_blank">
                                                    ...
                                                    <td class="text-center">
                                                        <a class="btn btn-sm success"
                                                           href="{{ route("topicsFilesEdit",["webmasterId"=>$WebmasterSection->id,"id"=>$Topics->id,"comment_id"=>$file->id]) }}">
                                                            <small><i class="material-icons">
                                                                    &#xe3c9;</i> {{ trans('backLang.edit') }}</small>
                                                        </a>
                                                        @if(@Auth::user()->permissionsGroup->delete_status)
                                                    ...
                                                    <div class="modal-dialog" id="animate">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn dark-white p-x-md"
                                                                        data-dismiss="modal">{{ trans('backLang.no') }}</button>
                                                                <a href="{{ route("topicsFilesDestroy",["webmasterId"=>$WebmasterSection->id,"id"=>$Topics->id,"comment_id"=>$file->id]) }}"
                                                                   class="btn danger p-x-md">{{ trans('backLang.yes') }}</a>
                                                            </div>
                                                        </div><!-- /.modal-content -->
                                                    </div>
